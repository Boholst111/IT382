    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-neutral-50 px-4">
      ...
      <Card className="w-full max-w-md shadow-2xl border-0 shadow-blue-100/50">
         <CardHeader className="space-y-1 mb-2 mt-4">
            <CardTitle className="text-3xl font-bold text-center text-neutral-900">Sign In</CardTitle>
         ...
         <CardContent>
            <form className="flex-1 flex flex-col w-full justify-center gap-5 text-foreground">
               ...
               <div className="pt-2 flex flex-col gap-3">
                 <Button type="submit" formAction={login} className="w-full bg-blue-600 hover:bg-blue-700 h-12 text-md">
                    Sign In
                 </Button>
                 <Button type="submit" formAction={signup} variant="outline" className="w-full h-12 text-md text-blue-700 border-blue-200 hover:bg-blue-50">
                    Create Account
                 </Button>
               </div>
            </form>
